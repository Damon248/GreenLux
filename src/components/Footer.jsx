  ...
  return (
    <footer className=" bg-PrimaryColor text-ExtraDarkColor rounded-t-3xl mt-8 md:mt-0">
      <div className="flex flex-col md:flex-row justify-between p-8 md:px-32 px-5">
        <div>
          <h1 className=" font-semibold text-3xl pb-4">GreenLux</h1>
          <p className=" font-medium text-l pb-4 pt-5 md:pt-0">
            The future is sustainable & it is one tap away
          </p>
      ...
      <div>
        <p className=" text-center py-4">
          ...
          <span className=" text-black"> Green Lux</span> | All rights reserved
        </p>
      </div>
    </footer>
  );
